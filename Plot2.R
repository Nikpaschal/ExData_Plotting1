# Plot2.R comprises of a series of functions and commands to download and subset Electrical 
...
#Read, rename and subset a certain set of the data based on dates
...
# plot 
plot(Feb2007_power$Time,Feb2007_power$Global_active_power,type="l",xlab="",ylab="Global Active Power (kilowatts)", main="Global Active Power Vs Time") 
